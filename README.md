...
3. Add `charts` to the `ckan.plugins` setting in your CKAN
...
**TODO:** Document any optional config settings here. For example:
	...
	# (optional, default: 24).
	ckanext.charts.some_setting = some_default_value
...
## Releasing a new version of ckanext-charts

If ckanext-charts should be available on PyPI you can follow these steps to publish a new version:
